  ...
  return (
    <div className="container">
      <Popup title="Сообщение: учётная запись не активирована">
        ...
        <p>
          Если письмо с кодом активации не было получено на почту
          mail@excont.ru, нажмите кнопку «Отправить код активации повторно»:
        </p>
        <button type="button" className="btn">
        ...
        <p>
          ...
          это так, измените адрес. Код активации будет отправлен по новому
          адресу автоматически, после нажатия на кнопку «Изменить E-mail»:
        </p>
